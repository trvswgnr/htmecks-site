// https://htmecks.org/reference/#api

/**
 * This method adds a class to the given element.
 *
 * https://htmecks.org/api/#addClass
 *
 ...
 *
 * Note that using a [meta tag](https://htmecks.org/docs/#config) is the preferred mechanism for setting these properties.
 *
 * https://htmecks.org/api/#config
 */
export var config: HtmxConfig;

/**
 * A property used to create new [Server Sent Event](https://htmecks.org/docs/#sse) sources. This can be updated to provide custom SSE setup.
 *
 * https://htmecks.org/api/#createEventSource
 */
export var createEventSource: (url: string) => EventSource;

/**
 * A property used to create new [WebSocket](https://htmecks.org/docs/#websockets). This can be updated to provide custom WebSocket setup.
 *
 * https://htmecks.org/api/#createWebSocket
 */
export var createWebSocket: (url: string) => WebSocket;

/**
 * Defines a new htmx [extension](https://htmecks.org/extensions).
 *
 * https://htmecks.org/api/#defineExtension
 *
 ...
 *
 * https://htmecks.org/api/#parseInterval
 *
 ...
 *
 * https://htmecks.org/api/#removeClass
 *
 ...
 *
 * https://htmecks.org/api/#removeExtension
 *
 ...
 *
 * https://htmecks.org/api/#takeClass
 *
 ...
 *
 * https://htmecks.org/api/#toggleClass
 *
...
export interface HtmxConfig {
    ...
    */
    ...
    /**
     * The default swap style to use if **[hx-swap](https://htmecks.org/attributes/hx-swap)** is omitted.
     * @default "innerHTML"
     */
...
/**
 * https://htmecks.org/extensions/#defining
 */
